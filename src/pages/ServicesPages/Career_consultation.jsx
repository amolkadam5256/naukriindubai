...
export default function Career_consultation() {
  const service = {
    title: "Career Counseling & Consultation",
    tagline: "Your Career Journey — Guided with Clarity.",
    description:
      "Our Career Counseling & Consultation services empower professionals, students, and job seekers to make informed career decisions. From one-on-one counseling to Gulf market insights, we help you align your skills, interests, and goals with the right opportunities.",
    highlights: [
      "One-on-One Career Counseling",
      "Gulf Market Orientation & Awareness",
      "Personalized Career Roadmap Planning",
      "Student Guidance & Career Growth Strategy",
      "Professional Transition & Skill Alignment",
    ],
    contact: {
  ...
  const bgImage =
    "https://images.unsplash.com/photo-1521737604893-d14cc237f11d?auto=format&fit=crop&w=1600&q=80"; // meeting & mentoring
  const profileImage =
    "https://images.unsplash.com/photo-1581093588401-22c9c3d6d0f7?auto=format&fit=crop&w=800&q=60"; // coach consultation
  const overlayImage =
    "https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&w=600&q=60"; // professional mentoring
    ...
    <div className="bg-white text-black">
          ...
          >
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="relative w-[85%] h-[85%]">
                ...
                >
                  <div className="font-semibold">1500+ Professionals Guided</div>
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto text-center">
          ...
          >
            Whether you’re a student exploring future options or a professional seeking a career shift, our consultation helps you find clarity. We analyze your goals, market trends, and strengths to craft a clear, actionable growth strategy.
          </motion.p>
        </div>
          ...
          {[
            {
              ...
              desc: "Get a customized plan that aligns your goals, skills, and interests with the right global career opportunities.",
            },
            {
              title: "Gulf Market Insights",
              desc: "Understand Dubai’s evolving job landscape and how to strategically position yourself for success.",
            },
            {
              title: "Student & Professional Guidance",
              desc: "We assist both aspiring students and experienced professionals to find meaningful, growth-oriented paths.",
            },
          ].map((item, index) => (
            <motion.div
              key={index}
